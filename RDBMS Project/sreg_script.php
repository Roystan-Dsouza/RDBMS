...
$donation_amt = mysqli_escape_string($con, filter_input(INPUT_POST, 'DonationAmount'));
$payment_type =  filter_input(INPUT_POST, 'PaymentType');
$user_registration_query = "insert into sponsor(name,contact,email,address,city,donation_amt,payment_type) values ('$name', '$contact', '$email','$address','$city','$donation_amt','$payment_type')";
$user_registration_submit = mysqli_query($con, $user_registration_query) or die(mysqli_error($con));
?>
<p style="font-size: 25px">Your application has been submitted.Your application id is 
    <?php
    $sql = "SELECT * FROM sponsor WHERE contact=$contact";
...
#$organisation =  mysqli_escape_string($con, filter_input(INPUT_POST, 'organisation'));
$donation_amt = mysqli_escape_string($con, filter_input(INPUT_POST, 'donation_amt'));
