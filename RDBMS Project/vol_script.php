...
$user_registration_query = "insert into volunteer(name,contact,email,address,city,skill,organisation) values ('$name', '$contact', '$email','$address','$city','$skill','$organisation')";
$user_registration_submit = mysqli_query($con, $user_registration_query) or die(mysqli_error($con));
?>
<p style="font-size: 25px">Your application has been submitted.Your application id is 
    <?php
    $sql = "SELECT * FROM volunteer WHERE contact=$contact";
